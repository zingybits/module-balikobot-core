...
namespace ZingyBits\BalikobotCore\Model\Order\Email\Sender;
...
class OrderSender extends Sender
{
    ...
    {
        $balikobotLabelUrl = json_decode($order->getBalikobotJson(), true)['label_url'];
        ...
        $transport = [
            ...
            'balikobot_label_url' => $balikobotLabelUrl,
            'order_data' => [
        ...
        $templateId = Config::BALIKOBOT_ORDER_TEMPLATE;
